    ...
    <div class="legal-page">
      <div class="legal-container">
        ...
        <div *ngIf="!loading && !hasContent" class="empty-state">
          ...
          <h2 class="empty-state-title">{{ 'legal.privacy.notConfigured' | translate }}</h2>
          <p class="empty-state-message">{{ 'legal.privacy.notConfiguredDesc' | translate }}</p>
...
export class DatenschutzStoreComponent extends LegalBaseComponent {
  protected getContentField(): string | null | undefined {
    return this.store?.privacyPolicyText;
  }

  protected getEmptyTitleKey(): string {
    return 'legal.privacy.notConfigured';
  }

  protected getEmptyTextKey(): string {
    return 'legal.privacy.notConfiguredDesc';
  }
}

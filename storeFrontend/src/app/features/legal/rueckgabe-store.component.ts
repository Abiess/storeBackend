  ...
  template: `
    <div class="legal-page">
      <div class="legal-container">
        <h1 class="legal-title">{{ 'legal.return.title' | translate }}</h1>
        ...
        <div *ngIf="!loading && !hasContent" class="empty-state">
          ...
          <h2 class="empty-state-title">{{ 'legal.return.notConfigured' | translate }}</h2>
          <p class="empty-state-message">{{ 'legal.return.notConfiguredDesc' | translate }}</p>
...
export class RueckgabeStoreComponent extends LegalBaseComponent {
  protected getContentField(): string | null | undefined {
    return this.store?.returnPolicyText;
  }

  protected getEmptyTitleKey(): string {
    return 'legal.return.notConfigured';
  }

  protected getEmptyTextKey(): string {
    return 'legal.return.notConfiguredDesc';
  }
}

    ...
    <div class="legal-page">
      <div class="legal-container">
        ...
        <div *ngIf="!loading && !hasContent" class="empty-state">
          ...
          <h2 class="empty-state-title">{{ 'legal.terms.notConfigured' | translate }}</h2>
          <p class="empty-state-message">{{ 'legal.terms.notConfiguredDesc' | translate }}</p>
...
export class AgbStoreComponent extends LegalBaseComponent {
  protected getContentField(): string | null | undefined {
    return this.store?.termsAndConditionsText;
  }

  protected getEmptyTitleKey(): string {
    return 'legal.terms.notConfigured';
  }

  protected getEmptyTextKey(): string {
    return 'legal.terms.notConfiguredDesc';
  }
}

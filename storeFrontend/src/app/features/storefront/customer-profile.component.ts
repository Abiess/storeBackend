...
import { CustomerProfileService, CustomerProfile, OrderHistory } from '../../core/services/customer-profile.service';
...
export class CustomerProfileComponent implements OnInit {
  ...
  loadOrderHistory(): void {
    ...
    this.customerService.getOrderHistory(email).subscribe({
      next: (orders) => {
        ...
        console.log('✅ Bestellhistorie geladen:', orders.length, 'Bestellungen');
      },
      error: (error) => {
  ...
  getCompletedOrders(): number {
    return this.orderHistory.filter(o => o.status === 'DELIVERED').length;
  }

  getPendingOrders(): number {
    return this.orderHistory.filter(o =>

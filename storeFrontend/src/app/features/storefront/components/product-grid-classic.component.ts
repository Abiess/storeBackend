...
@Component({
    ...
    <div class="classic-layout">
      ...
      <div class="classic-main">
        ...
        <div class="load-more-wrap" *ngIf="hasMore">
          <p class="load-more-count">{{ visibleProducts.length }} / {{ filteredProducts.length }}</p>
  ...
  styles: [`
    ...
    .load-more-count { font-size: 0.8rem; color: #6b7280; margin-bottom: 0.75rem; }
    .load-more-btn {
...
export class ProductGridClassicComponent implements OnChanges {

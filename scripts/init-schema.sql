...
-- Stores Tabelle (MUSS vor Domains/Wishlists/SavedCarts existieren)
CREATE TABLE stores (
                      id BIGSERIAL PRIMARY KEY,
...
-- Orders Tabelle (FIX: enthält jetzt die neuen Spalten)
CREATE TABLE orders (
                      id BIGSERIAL PRIMARY KEY,
...
-- Wishlists (jetzt OK, weil stores existiert)
...
-- Ownership + Rechte + Default Privileges
DO $$
DECLARE r RECORD;
BEGIN

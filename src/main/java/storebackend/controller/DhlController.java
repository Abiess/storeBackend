...
public class DhlController {
    ...
    private final storebackend.service.DhlShelfSlotService shelfSlotService; // Phase 3A.5
    ...
    // ════════════════════════════════════════════════════════════════════════
    // PHASE 3A.5 - FACHVERWALTUNG (SLOT MANAGEMENT)
    // ════════════════════════════════════════════════════════════════════════
    
    /**
     * GET /api/stores/{storeId}/dhl/slots
     * 
     * Listet alle Fächer eines Stores
     * 
     * Response: Array von Slots mit occupiedCount
     * [
     *   {
     *     "id": 123,
     *     "storeId": 121,
    ...
    public ResponseEntity<List<DhlShelfSlotDto>> getSlots(
        ...
        List<storebackend.entity.DhlShelfSlot> slots = shelfSlotService.listAllSlots(storeId);
        ...
        List<DhlShelfSlotDto> dtos = slots.stream()
            .map(slot -> {
                ...
                // Occupied Count (TODO: optimize mit JOIN Query)
     ...
     */
    @PostMapping("/slots")
    public ResponseEntity<storebackend.entity.DhlShelfSlot> createSlot(
        @PathVariable Long storeId,
        ...
        storebackend.entity.DhlShelfSlot slot = shelfSlotService.createSingleSlot(
            storeId,
            request.getCode(),
            request.getCapacity(),
    ...
    public ResponseEntity<List<storebackend.entity.DhlShelfSlot>> createBulkSlots(
        @PathVariable Long storeId,
        ...
        List<storebackend.entity.DhlShelfSlot> slots = shelfSlotService.createBulkSlots(
            storeId,
            request.getPrefix(),
    ...
    public ResponseEntity<storebackend.entity.DhlShelfSlot> updateSlot(
        @PathVariable Long storeId,
        ...
        storebackend.entity.DhlShelfSlot slot = shelfSlotService.updateSlot(
            storeId,
            slotId,
            request.getCapacity(),
            request.getActive(),

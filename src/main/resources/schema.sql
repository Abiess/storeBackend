...
VALUES
    (NULL, 'Bestellung & Lieferung', 'order-delivery', 'Fragen zu Bestellungen und Versand', '📦', 1),
...
WITH faq_seed AS (
    ...
    CROSS JOIN (
        VALUES
            ...
            ('Wie kann ich meine Bestellung verfolgen?',
             'Sie können Ihre Bestellung jederzeit über die Bestellnummer verfolgen. Nutzen Sie dazu unseren Chat und geben Sie einfach Ihre Bestellnummer ein.',
             'bestellung,verfolgen,tracking,sendung,lieferung',
             1),
            ('Wie lange dauert die Lieferung?',
             'Die Lieferzeit beträgt in der Regel 2-5 Werktage innerhalb Deutschlands. Express-Versand ist ebenfalls verfügbar.',
             'lieferzeit,dauer,versand,express',
             2),
            ('Was kostet der Versand?',
             'Der Standardversand kostet 4,99€. Ab einem Bestellwert von 50€ ist der Versand kostenlos.',
            ...
            ('Kann ich meine Bestellung stornieren?',
             'Ja, Sie können Ihre Bestellung innerhalb von 2 Stunden nach Aufgabe stornieren. Kontaktieren Sie uns über den Chat.',
             'stornieren,abbrechen,cancel,zurückgeben',
             2),
            ('Wie funktioniert die Rückgabe?',
             'Sie haben 14 Tage Rückgaberecht. Bitte nutzen Sie das Rückgabeformular in Ihrem Kundenkonto.',
             'rückgabe,zurücksenden,return,widerrufsrecht',
             3),
            -- Products
            ('Ist das Produkt auf Lager?',
             'Sie sehen die Verfügbarkeit direkt auf der Produktseite. Bei Fragen zu spezifischen Produkten kontaktieren Sie uns über den Chat.',
             'verfügbarkeit,lagerbestand,stock,vorrätig',
             1),
            ('Gibt es Mengenrabatte?',
             'Ja, ab 5 Stück desselben Produkts gewähren wir automatisch 10% Rabatt.',
             'rabatt,discount,mengenrabatt,bulk',
             2),
            -- Account
            ('Wie erstelle ich ein Konto?',
             'Klicken Sie oben rechts auf "Anmelden" und dann auf "Registrieren". Sie benötigen nur eine E-Mail-Adresse.',
             'konto,account,registrieren,anmelden',
             1),
            ('Ich habe mein Passwort vergessen',
             'Klicken Sie auf "Passwort vergessen?" auf der Login-Seite. Sie erhalten dann eine E-Mail zum Zurücksetzen.',
    ...
    WHERE c.store_id IS NULL
      AND (
          ...
          OR (c.slug = 'products-availability' AND q.display_order <= 2 AND q.keywords LIKE '%verfügbarkeit%')
...
VALUES
    ...
    (NULL, 'faq_request', 'FAQ anfordern',
     '["häufige fragen","faq","hilfe","support","frage"]',
     'Hier sind unsere häufigsten Fragen. Was interessiert Sie?',
     'SHOW_FAQ'),
